...
void demo() {
    ...
    int8_t deltaY = 1;
    while (1) {
        tftstDrawHorizontalLine(6, y - 1, 160, 0x0000);
        tftstDrawText(6, y, "funStackLabs", 0x07E0, 0x0000, 2);
        tftstDrawHorizontalLine(6, y + 14, 160, 0x0000);
        y += deltaY;
        if (y == 0 || y == 114) {
            deltaY = -deltaY;
            y += deltaY;
        ...
        tftstDrawText(0, 0, idString, 0x07E0, 0x0000, 1);
        if (id != 124) {
            tftstInit();
            tftstFillScreen(0x0000);
        }
